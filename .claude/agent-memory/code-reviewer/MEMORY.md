...
- [CORS 와일드카드→화이트리스트 전환](cors_whitelist_vs_documented_convention.md) — 2026-09-24, middleware.ts 화이트리스트 구현이 .claude/memory/cors-setup.md 문서(env var, Vary: Origin, 403, Set)와 불일치. Vary 누락 Major(비차단), APPROVED(조건부)
